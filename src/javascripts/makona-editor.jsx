...
MakonaPlusRow = React.createClass({
  ...
  blockTypeLink: function(block) {
    return <a href="javascript: void(0);" onClick={this.addRow.bind(this, block.type)} data-type={block.type}><div className="icon" data-icon={block.icon}></div><div>{block.displayName}</div></a>;
  },
  blockTypes: function() {
    var _this = this;
