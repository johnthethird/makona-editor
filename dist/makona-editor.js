...
>>>>>>> d9f10ac1c326b1a3f86bbca3da73cc0a8da6fce9
	...
	MakonaSortableItem = React.createClass({
	  ...
	  componentDidMount: function() {
	    return Channel.subscribe("block.caret", (function(_this) {
	      return function(data) {
	        return _this.handleCaret(data.block);
	      };
	    })(this));
	  },
	  handleCaret: function(block) {
	    var ref;
	    if (ref = this.refs["editor" + block.id]) {
	      return setTimeout((function(_this) {
	        return function() {
	          return $(ref.getDOMNode()).find("textarea").focus().caretToEnd();
	        };
	      })(this), 200);
	    }
	  },
	...
	MakonaRaw = React.createClass({
	  ...
	  render: function() {
	    ...
	    return (ref1 = React.DOM).div.apply(ref1, [null].concat(slice.call(ary)));
	  }
	});
	...
	BLOCK_REGISTRY = [
	  {
	    type: "unknown",
<<<<<<< HEAD
	    previewClass: __webpack_require__(5),
=======
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(25)(__webpack_require__(29))
...
<<<<<<< HEAD
	__webpack_require__(25)(__webpack_require__(34))
=======
